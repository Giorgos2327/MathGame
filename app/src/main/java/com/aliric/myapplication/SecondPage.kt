       ...
       mutableStateOf(
           object :CountDownTimer(totalTimeInMillis.value,1000){
               override fun onTick(millisUntilFinished: Long) {
                   ...
                   time.value=String.format(Locale.getDefault(),"%02d",millisUntilFinished/1000)
               }
        ...
        topBar = {
            ...
            Column(
                modifier = Modifier
                    ...
                    .padding(padding)
                    .paint(
                        painter = painterResource(id = R.drawable.mathgamepage2imageeasy),
...

            {
                ...
                Row(
                    ...
                    Text(text = time.value, fontSize = 16.sp, color = Color.White)
                        ...
                        myOnClick = {
                            ...
                            if (life.value == 0){
                                ...
                                navController.navigate("ResultPage/${score.value}"){
                                    popUpTo("MathGame"){inclusive=false}
                                }
                            }
                            else{
